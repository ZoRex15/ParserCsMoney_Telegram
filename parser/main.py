...
def start(name: str ,price: int):
    global c
    cookies = {
        'region': 'Grodnenskaya',
        'cc_service2': '{%22services%22:[%22necessary%22%2C%22gtm%22%2C%22ym%22%2C%22amplitude%22%2C%22gleam%22%2C%22esputnik%22%2C%22hotjar%22%2C%22userSesDatToAnalytic%22%2C%22userSesDatToMarketing%22%2C%22cardVisualSize%22]%2C%22acceptanceDate%22:1708281882726%2C%22revision%22:0}',
        'group_id': 'd42c470d-7dea-4e74-add3-104d15440d4e',
        'sc': '5130948A-2EFB-54FC-AF9F-339C47DB13B2',
        '_gcl_au': '1.1.42814056.1708281883',
        '_ga_HY7CCPCD7H': 'GS1.1.1708406151.3.1.1708406732.60.0.0',
        '_ga': 'GA1.1.894398092.1708281884',
        'cf_clearance': 'OjXPtZSxmcGvvvs8cWv8uYImO58e4vboOBKBS61wm8s-1708406149-1.0-AWKlDIMlvQn6DzCzb16wKSkLtbewwWeLGbhJI4Qa5VUoOrlrBGlq4aoP+Lp6CbhjhZLZ5bft4KOcj2uokBbXRL4=',
        '_ga_CFRN8YJV66': 'GS1.1.1708406151.3.0.1708406151.0.0.0',
        'ouid': '60299031_1734003192',
        '_ym_uid': '1708281886412497733',
        '_ym_d': '1708281886',
        '_scid': 'eafb7b8f-21ae-4a77-99ec-d91424da7f0a',
        'amplitude_id_c14fa5162b6e034d1c3b12854f3a26f5cs.money': 'eyJkZXZpY2VJZCI6IjMwYzc3N2U0LTBmZGMtNDVhMi1hYzM5LTQ1ZDhjOTc3MWU5MVIiLCJ1c2VySWQiOm51bGwsIm9wdE91dCI6ZmFsc2UsInNlc3Npb25JZCI6MTcwODQwNjE0NzUwNywibGFzdEV2ZW50VGltZSI6MTcwODQwNjczMjYwMiwiZXZlbnRJZCI6MjksImlkZW50aWZ5SWQiOjM3LCJzZXF1ZW5jZU51bWJlciI6NjZ9',
        ...
        '_scid_r': 'eafb7b8f-21ae-4a77-99ec-d91424da7f0a',
        '_uetsid': 'c962ac70ce8d11eeb5d901acd8280a1f',
    ...
    while True:
        ...
        lowest_price = min(hash,key=lambda x: x[0])
        if lowest_price < price:
            print('Нашли скин с низкой ценой!')
        print(c) # количество запросов
...
if __name__ == '__main__':
    start('★ M9 Bayonet | Fade (Factory New)',12000)
